                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                                        {dish.dietary_tags?.map((tag: string) => (
                                            <span key={tag} style={{ fontSize: "12px", fontWeight: 600, color: "var(--brand-primary)", backgroundColor: "rgba(244, 193, 47, 0.1)", padding: "4px 10px", borderRadius: "99px" }}>
                                                {tagFr(tag)}
                                            </span>
                                        ))}
                                    </div>
