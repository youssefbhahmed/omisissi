...
export default function BookingsClient({ pendingRequests, otherBookings }: { pendingRequests: BookingListItem[], otherBookings: BookingListItem[] }) {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            case "pending": return { bg: "rgba(255, 184, 0, 0.1)", color: "var(--brand-primary)" };
                ...
                <section>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "24px" }}>
                        {pendingRequests.map(req => {
                            ...
                            return (
                                <div key={req.id} className="card" style={{ padding: "24px", backgroundColor: "var(--bg-surface)", border: "2px solid rgba(255, 184, 0, 0.3)", position: "relative" }}>
                                    <div style={{ position: "absolute", top: "24px", right: "24px", backgroundColor: "rgba(255, 184, 0, 0.1)", color: "var(--brand-primary)", padding: "4px 10px", borderRadius: "99px", fontSize: "11px", fontWeight: 700, textTransform: "uppercase" }}>
                                        Nouvelle demande
                                    </div>
                                    ...
                                    <div style={{ backgroundColor: "var(--bg-base)", padding: "16px", borderRadius: "12px", border: "1px solid var(--border-light)", marginBottom: "20px" }}>
                                        ...
                                        {req.notes && (
                                            <div style={{ marginTop: "12px", padding: "12px", backgroundColor: "rgba(255, 184, 0, 0.05)", borderRadius: "8px", borderLeft: "2px solid var(--brand-primary)", fontSize: "13px" }}>
