        ...
        <div className="card" style={{ padding: "20px 24px", backgroundColor: "var(--bg-surface)", border: "1px solid var(--border-light)", display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: "200px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
                    ...
                    {!cook.hasRate && (
                        <span style={{ fontSize: "11px", fontWeight: 700, color: "#d97706", backgroundColor: "rgba(244, 193, 47,0.12)", padding: "2px 8px", borderRadius: "99px" }}>profil incomplet</span>
                    )}
                </div>
...
export default async function AdminPage() {
    ...
    return (
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            {!migrationApplied && (
                <div className="card" style={{ padding: "20px 24px", marginBottom: "24px", backgroundColor: "rgba(244, 193, 47,0.1)", border: "1px solid rgba(244, 193, 47,0.3)" }}>
