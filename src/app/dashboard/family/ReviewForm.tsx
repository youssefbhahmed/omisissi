...
export default function ReviewForm({ bookingId, cookName }: { bookingId: string; cookName: string }) {
    ...
    return (
        <div style={{ padding: "16px", borderRadius: "12px", border: "1.5px solid var(--brand-primary)", backgroundColor: "rgba(198, 70, 43, 0.05)", display: "flex", flexDirection: "column", gap: "12px" }}>
