                        ...
                        <>
                            <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxHeight: "240px", overflowY: "auto", paddingRight: "8px" }}>
                                {dishes.length === 0 ? (
                                    ...
                                    return (
                                    <div key={d.id} style={{ padding: "12px", borderRadius: "14px", border: `1.5px solid ${isSelected ? "var(--brand-primary)" : "var(--border-light)"}`, backgroundColor: isSelected ? "rgba(255, 184, 0, 0.04)" : "var(--bg-base)", transition: "all 0.2s" }}>
                            ...
                            {totalDishCount > 0 && (
                                <div style={{ padding: "12px 16px", borderRadius: "10px", backgroundColor: "rgba(255, 184, 0, 0.08)", border: "1px solid rgba(255, 184, 0, 0.2)", fontSize: "13px", color: "var(--text-body)" }}>
